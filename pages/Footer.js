          ...
          <div className="container px-5 py-8 flex flex-wrap mx-auto items-center">
            <div className="flex md:flex-nowrap flex-wrap justify-center items-end md:justify-start">
              <div className="relative sm:w-64 w-40 sm:mr-4 mr-2">
                ...
                <input placeholder='email...' type="text" id="footer-field" name="footer-field" className="w-full bg-gray-800 bg-opacity-40 
              ...
              <button className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Send</button>
            </div>
            <span className="inline-flex lg:ml-auto lg:mt-0 mt-6 w-full justify-center md:justify-start md:w-auto">
              ...
              <a className="ml-3 text-gray-400" href=' https://www.linkedin.com/in/shubham-tiwari-b7544b193/' rel="noreferrer" target='_blank'>
                <svg fill="currentColor" strokeLinecap="currentColor" strokeLinecap="round" strokeline-linejoin="round" strokelinecap-width="0" className="w-5 h-5" viewBox="0 0 24 24">
